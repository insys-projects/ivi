...
int main ()
{
	...
	CHECK_ERROR("GetAttributeViReal64 - VERTICAL_RANGE", error = tkdpo4k_GetAttributeViReal64(vi, CH1, IVISCOPE_ATTR_VERTICAL_RANGE, &rangeY));
	CHECK_ERROR("GetAttributeViReal64 - VERTICAL_OFFSET", error = tkdpo4k_GetAttributeViReal64(vi, CH1, IVISCOPE_ATTR_VERTICAL_OFFSET, &offsetY));
		
	CHECK_ERROR("SampleRate", error = tkdpo4k_SampleRate(vi, &rateX));

 ...
 *            efficiency measurement acquisition, displays the measurement in 
 *            a pop-up dialog box.
 *
...

{
    ...
    ViChar      szBuf[1024];
    ViString    strMsg1 = "The Efficiency measurement result is %lf"
    ...
    checkErr( agx2k3k_ApplyPowerEfficiency(agx2k3k));
    
    checkErr( agx2k3k_ReadEfficiency(agx2k3k, &measurement));

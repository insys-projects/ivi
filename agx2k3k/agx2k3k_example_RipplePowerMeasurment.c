 ...
 *            ripple measurement acquisition, and
 *            displays the measurement in a pop-up dialog box.
 *
 ...
 *            ripple measurement result by setting the ripple channel to CHAN1
...

{
    ...
    ViChar      szBuf[1024];
    ViString    strMsg1 = "The Ripple measurement result is %lf"
    ...
    checkErr( agx2k3k_ApplyPowerRipple(agx2k3k));
    
    checkErr( agx2k3k_ReadRipple (agx2k3k, "CHAN1", &measurement));
    
    sprintf(szBuf, strMsg1, measurement);
